...
Future<void> registerRegionModule() async {
  ...
  // Register repository
  di.registerLazySingleton<RegionRepository>(() => RegionRepositoryImpl(remoteSource: di()));

  // Register usecase
  di.registerLazySingleton<GetRegionsUsecase>(() => GetRegionsUsecase(repository: di()));
  di.registerLazySingleton<AddRegionUseCase>(() => AddRegionUseCase(repository: di()));

  // Register bloc
  di.registerFactory<RegionBloc>(() => RegionBloc(
