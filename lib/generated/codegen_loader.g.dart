...
static const Map<String,dynamic> _fr = {
  ...
  "movement": {
    ...
    "new": {
      ...
      "content": "Formulaire de nouveau mouvement à implémenter",
    ...
    "notes": "Notes",
    "fromPackaging": "Conditionnement source",
    "toPackaging": "Conditionnement destination",
    "quantity": "Quantité",
    "wine": "Vin",
    "location": "Emplacement",
    "date": "Date",
    "delete": {
      ...
      "confirmation": "Êtes-vous sûr de vouloir supprimer ce mouvement ?"
    },
  ...
  "movements": {
    ...
    "delete": "Supprimer le mouvement",
    "deleteConfirmation": "Êtes-vous sûr de vouloir supprimer ce mouvement ?",
    "form": {
      "title": "Nouveau mouvement",
      "type": "Type de mouvement",
      "date": "Date",
      ...
      "cancel": "Annuler",
      "validation": {
        "type": "Veuillez sélectionner un type de mouvement",
        "date": "Veuillez sélectionner une date",
        "wine": "Veuillez sélectionner un vin",
        "quantity": "Veuillez entrer une quantité",
        "fromLocation": "Veuillez sélectionner un emplacement source",
        "toLocation": "Veuillez sélectionner un emplacement destination"
      }
    }
  }
};
